...
Group 16: Konstantina Gkopi(s243692), Eric Torres (s243275), Lucía de Lamadrid (s243311), Jorge Santiago (s24), Elena Iriondo (s24)

#### **T7: Like T6, but with densitograms** GROUP ASSIGNMENT

We first have to load the .RData file in which the microarray tibble is present:
```{r}
